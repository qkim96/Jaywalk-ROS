...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuri_person_tracking-msg:<BoundingBox> is deprecated: use kuri_person_tracking-msg:BoundingBox instead.")))

(cl:ensure-generic-function 'xmin-val :lambda-list '(m))
(cl:defmethod xmin-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuri_person_tracking-msg:xmin-val is deprecated.  Use kuri_person_tracking-msg:xmin instead.")
  (xmin m))

(cl:ensure-generic-function 'ymin-val :lambda-list '(m))
(cl:defmethod ymin-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuri_person_tracking-msg:ymin-val is deprecated.  Use kuri_person_tracking-msg:ymin instead.")
  (ymin m))

(cl:ensure-generic-function 'xmax-val :lambda-list '(m))
(cl:defmethod xmax-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuri_person_tracking-msg:xmax-val is deprecated.  Use kuri_person_tracking-msg:xmax instead.")
  (xmax m))

(cl:ensure-generic-function 'ymax-val :lambda-list '(m))
(cl:defmethod ymax-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuri_person_tracking-msg:ymax-val is deprecated.  Use kuri_person_tracking-msg:ymax instead.")
  (ymax m))

(cl:ensure-generic-function 'probability-val :lambda-list '(m))
(cl:defmethod probability-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuri_person_tracking-msg:probability-val is deprecated.  Use kuri_person_tracking-msg:probability instead.")
  (probability m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BoundingBox>)))
  ...
  (cl:format cl:nil "float64 xmin~%float64 ymin~%float64 xmax~%float64 ymax~%float64 probability~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BoundingBox)))
  "Returns full string definition for message of type 'BoundingBox"
  (cl:format cl:nil "float64 xmin~%float64 ymin~%float64 xmax~%float64 ymax~%float64 probability~%~%~%"))
