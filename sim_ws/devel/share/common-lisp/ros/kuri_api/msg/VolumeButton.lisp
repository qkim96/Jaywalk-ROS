...
(cl:defmethod cl:initialize-instance :after ((m <VolumeButton>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VolumeButton)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuri_api-msg:<VolumeButton> is deprecated: use kuri_api-msg:VolumeButton instead.")))

(cl:ensure-generic-function 'up_button_pressed-val :lambda-list '(m))
(cl:defmethod up_button_pressed-val ((m <VolumeButton>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuri_api-msg:up_button_pressed-val is deprecated.  Use kuri_api-msg:up_button_pressed instead.")
  (up_button_pressed m))

(cl:ensure-generic-function 'down_button_pressed-val :lambda-list '(m))
(cl:defmethod down_button_pressed-val ((m <VolumeButton>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuri_api-msg:down_button_pressed-val is deprecated.  Use kuri_api-msg:down_button_pressed instead.")
