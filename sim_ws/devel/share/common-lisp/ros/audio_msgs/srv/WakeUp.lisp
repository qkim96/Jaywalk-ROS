...
(cl:defmethod cl:initialize-instance :after ((m <WakeUp-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WakeUp-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name audio_msgs-srv:<WakeUp-request> is deprecated: use audio_msgs-srv:WakeUp-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <WakeUp-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WakeUp-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name audio_msgs-srv:<WakeUp-response> is deprecated: use audio_msgs-srv:WakeUp-response instead.")))
