...
(cl:defmethod cl:initialize-instance :after ((m <SetField-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetField-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name audio_msgs-srv:<SetField-request> is deprecated: use audio_msgs-srv:SetField-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetField-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetField-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name audio_msgs-srv:<SetField-response> is deprecated: use audio_msgs-srv:SetField-response instead.")))
