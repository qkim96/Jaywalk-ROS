...
(cl:defmethod cl:initialize-instance :after ((m <GetField-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetField-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name audio_msgs-srv:<GetField-request> is deprecated: use audio_msgs-srv:GetField-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <GetField-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader audio_msgs-srv:name-val is deprecated.  Use audio_msgs-srv:name instead.")
  (name m))
...
(cl:defmethod cl:initialize-instance :after ((m <GetField-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetField-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name audio_msgs-srv:<GetField-response> is deprecated: use audio_msgs-srv:GetField-response instead.")))

(cl:ensure-generic-function 'json_value-val :lambda-list '(m))
(cl:defmethod json_value-val ((m <GetField-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader audio_msgs-srv:json_value-val is deprecated.  Use audio_msgs-srv:json_value instead.")
  (json_value m))
