...
(cl:defmethod cl:initialize-instance :after ((m <GetDirection-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetDirection-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gizmo_msgs-srv:<GetDirection-request> is deprecated: use gizmo_msgs-srv:GetDirection-request instead.")))

(cl:ensure-generic-function 'threshold-val :lambda-list '(m))
(cl:defmethod threshold-val ((m <GetDirection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gizmo_msgs-srv:threshold-val is deprecated.  Use gizmo_msgs-srv:threshold instead.")
  (threshold m))

(cl:ensure-generic-function 'ms_duration-val :lambda-list '(m))
(cl:defmethod ms_duration-val ((m <GetDirection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gizmo_msgs-srv:ms_duration-val is deprecated.  Use gizmo_msgs-srv:ms_duration instead.")
  (ms_duration m))

(cl:ensure-generic-function 'ms_delay-val :lambda-list '(m))
(cl:defmethod ms_delay-val ((m <GetDirection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gizmo_msgs-srv:ms_delay-val is deprecated.  Use gizmo_msgs-srv:ms_delay instead.")
  (ms_delay m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetDirection-request>)))
  ...
  "gizmo_msgs/GetDirectionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetDirection-request)))
  "Returns string type for a service object of type 'GetDirection-request"
  "gizmo_msgs/GetDirectionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetDirection-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetDirection-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gizmo_msgs-srv:<GetDirection-response> is deprecated: use gizmo_msgs-srv:GetDirection-response instead.")))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <GetDirection-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gizmo_msgs-srv:direction-val is deprecated.  Use gizmo_msgs-srv:direction instead.")
  (direction m))

(cl:ensure-generic-function 'relative_angle-val :lambda-list '(m))
(cl:defmethod relative_angle-val ((m <GetDirection-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gizmo_msgs-srv:relative_angle-val is deprecated.  Use gizmo_msgs-srv:relative_angle instead.")
  (relative_angle m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetDirection-response>)))
  ...
  "gizmo_msgs/GetDirectionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetDirection-response)))
  "Returns string type for a service object of type 'GetDirection-response"
  "gizmo_msgs/GetDirectionResponse")
