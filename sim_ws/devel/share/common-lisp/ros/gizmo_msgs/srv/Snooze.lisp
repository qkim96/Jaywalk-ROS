...
(cl:defmethod cl:initialize-instance :after ((m <Snooze-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Snooze-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gizmo_msgs-srv:<Snooze-request> is deprecated: use gizmo_msgs-srv:Snooze-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Snooze-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Snooze-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gizmo_msgs-srv:<Snooze-response> is deprecated: use gizmo_msgs-srv:Snooze-response instead.")))
