...
(cl:defmethod cl:initialize-instance :after ((m <Stat-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stat-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gizmo_msgs-srv:<Stat-request> is deprecated: use gizmo_msgs-srv:Stat-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Stat-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stat-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gizmo_msgs-srv:<Stat-response> is deprecated: use gizmo_msgs-srv:Stat-response instead.")))
