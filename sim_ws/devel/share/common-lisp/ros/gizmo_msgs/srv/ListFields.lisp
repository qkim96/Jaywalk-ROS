...
(cl:defmethod cl:initialize-instance :after ((m <ListFields-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ListFields-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gizmo_msgs-srv:<ListFields-request> is deprecated: use gizmo_msgs-srv:ListFields-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <ListFields-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ListFields-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gizmo_msgs-srv:<ListFields-response> is deprecated: use gizmo_msgs-srv:ListFields-response instead.")))

(cl:ensure-generic-function 'fields-val :lambda-list '(m))
(cl:defmethod fields-val ((m <ListFields-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gizmo_msgs-srv:fields-val is deprecated.  Use gizmo_msgs-srv:fields instead.")
  (fields m))
