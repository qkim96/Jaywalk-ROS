...
(cl:defmethod cl:initialize-instance :after ((m <Deafen-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Deafen-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gizmo_msgs-srv:<Deafen-request> is deprecated: use gizmo_msgs-srv:Deafen-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Deafen-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Deafen-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gizmo_msgs-srv:<Deafen-response> is deprecated: use gizmo_msgs-srv:Deafen-response instead.")))
