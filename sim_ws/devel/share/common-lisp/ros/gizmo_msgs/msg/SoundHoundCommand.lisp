...
(cl:defmethod cl:initialize-instance :after ((m <SoundHoundCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SoundHoundCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gizmo_msgs-msg:<SoundHoundCommand> is deprecated: use gizmo_msgs-msg:SoundHoundCommand instead.")))
...
(cl:defmethod params-val ((m <SoundHoundCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gizmo_msgs-msg:params-val is deprecated.  Use gizmo_msgs-msg:params instead.")
  (params m))
