...
(cl:defclass <Exchange> (roslisp-msg-protocol:ros-message)
  ((commands
    :reader commands
    :initarg :commands
    :type (cl:vector gizmo_msgs-msg:SoundHoundCommand)
   :initform (cl:make-array 0 :element-type 'gizmo_msgs-msg:SoundHoundCommand :initial-element (cl:make-instance 'gizmo_msgs-msg:SoundHoundCommand)))
   (error
    :reader error
    :initarg :error
    :type cl:string
...
(cl:defmethod cl:initialize-instance :after ((m <Exchange>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Exchange)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gizmo_msgs-msg:<Exchange> is deprecated: use gizmo_msgs-msg:Exchange instead.")))

(cl:ensure-generic-function 'commands-val :lambda-list '(m))
(cl:defmethod commands-val ((m <Exchange>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gizmo_msgs-msg:commands-val is deprecated.  Use gizmo_msgs-msg:commands instead.")
  (commands m))
...
(cl:defmethod transcription-val ((m <Exchange>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gizmo_msgs-msg:transcription-val is deprecated.  Use gizmo_msgs-msg:transcription instead.")
  (transcription m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Exchange>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'commands)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'gizmo_msgs-msg:SoundHoundCommand))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Exchange>)))
  ...
  (cl:format cl:nil "SoundHoundCommand[] commands~%string error~%string transcription~%~%================================================================================~%MSG: gizmo_msgs/SoundHoundCommand~%string name~%mayfield_msgs/KeyValue[] params~%~%================================================================================~%MSG: mayfield_msgs/KeyValue~%# Key value pair, with values represented as strings~%string k~%string v~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Exchange)))
  "Returns full string definition for message of type 'Exchange"
  (cl:format cl:nil "SoundHoundCommand[] commands~%string error~%string transcription~%~%================================================================================~%MSG: gizmo_msgs/SoundHoundCommand~%string name~%mayfield_msgs/KeyValue[] params~%~%================================================================================~%MSG: mayfield_msgs/KeyValue~%# Key value pair, with values represented as strings~%string k~%string v~%~%~%"))
