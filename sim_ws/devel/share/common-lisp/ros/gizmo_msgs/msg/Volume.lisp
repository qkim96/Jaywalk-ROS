...
(cl:defmethod cl:initialize-instance :after ((m <Volume>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Volume)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gizmo_msgs-msg:<Volume> is deprecated: use gizmo_msgs-msg:Volume instead.")))

(cl:ensure-generic-function 'level-val :lambda-list '(m))
(cl:defmethod level-val ((m <Volume>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gizmo_msgs-msg:level-val is deprecated.  Use gizmo_msgs-msg:level instead.")
  (level m))

(cl:ensure-generic-function 'is_relative-val :lambda-list '(m))
(cl:defmethod is_relative-val ((m <Volume>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gizmo_msgs-msg:is_relative-val is deprecated.  Use gizmo_msgs-msg:is_relative instead.")
  (is_relative m))

(cl:ensure-generic-function 'mute-val :lambda-list '(m))
(cl:defmethod mute-val ((m <Volume>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gizmo_msgs-msg:mute-val is deprecated.  Use gizmo_msgs-msg:mute instead.")
  (mute m))

(cl:ensure-generic-function 'unmute-val :lambda-list '(m))
(cl:defmethod unmute-val ((m <Volume>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gizmo_msgs-msg:unmute-val is deprecated.  Use gizmo_msgs-msg:unmute instead.")
  (unmute m))
