...
class StringStamped {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('timems')) {
        this.timems = initObj.timems
      }
      else {
        this.timems = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [timems]
    bufferOffset = _serializer.string(obj.timems, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [timems]
    data.timems = _deserializer.string(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.timems);
