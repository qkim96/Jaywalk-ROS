...
class CompressedOccupancyGrid {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CompressedOccupancyGrid(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CompressedOccupancyGrid(null);
...
module.exports = CompressedOccupancyGrid;
