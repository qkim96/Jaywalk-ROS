...
class ArcMoveActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ArcMoveFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ArcMoveFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ArcMoveActionFeedback(null);
    ...
    data.feedback = ArcMoveFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArcMoveActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ArcMoveFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ArcMoveFeedback()
    }
...
module.exports = ArcMoveActionFeedback;
