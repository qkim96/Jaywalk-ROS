...
class SoundHoundCommand {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SoundHoundCommand(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SoundHoundCommand(null);
...
module.exports = SoundHoundCommand;
