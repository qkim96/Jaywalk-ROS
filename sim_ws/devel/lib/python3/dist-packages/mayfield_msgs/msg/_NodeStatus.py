...
"""autogenerated by genpy from mayfield_msgs/NodeStatus.msg. Do not edit."""
import codecs
import sys
...
class NodeStatus(genpy.Message):
  _md5sum = "2938585155f971aea1e199f84d3637b6"
  _type = "mayfield_msgs/NodeStatus"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string node_name
bool online
"""
  __slots__ = ['node_name','online']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.online,) = _get_struct_B().unpack(str[start:end])
