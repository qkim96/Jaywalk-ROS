...
"""autogenerated by genpy from social_sim_ros/PersonEntryArray.msg. Do not edit."""
import codecs
import sys
...
import social_sim_ros.msg
import std_msgs.msg

class PersonEntryArray(genpy.Message):
  _md5sum = "8348034da65c22b0b7c89265fa8ea1ee"
  _type = "social_sim_ros/PersonEntryArray"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Message defining an array of all people entries
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','social_sim_ros/PersonEntry[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PersonEntryArray, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = social_sim_ros.msg.PersonEntry()
        _v9 = val1.header
        start = end
        end += 4
