...
"""autogenerated by genpy from gizmo_msgs/CalibrationPathActionResult.msg. Do not edit."""
import codecs
import sys
...
class CalibrationPathActionResult(genpy.Message):
  _md5sum = "89dbc4e75593b525bbbea3a150532ed6"
  _type = "gizmo_msgs/CalibrationPathActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gizmo_msgs/CalibrationPathResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CalibrationPathActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = gizmo_msgs.msg.CalibrationPathResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = gizmo_msgs.msg.CalibrationPathResult()
