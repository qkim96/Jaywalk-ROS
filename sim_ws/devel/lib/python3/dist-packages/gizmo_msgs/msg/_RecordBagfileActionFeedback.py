...
"""autogenerated by genpy from gizmo_msgs/RecordBagfileActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class RecordBagfileActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "gizmo_msgs/RecordBagfileActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gizmo_msgs/RecordBagfileFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RecordBagfileActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = gizmo_msgs.msg.RecordBagfileFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = gizmo_msgs.msg.RecordBagfileFeedback()
