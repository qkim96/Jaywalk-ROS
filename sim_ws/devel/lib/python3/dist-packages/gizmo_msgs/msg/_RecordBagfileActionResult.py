...
"""autogenerated by genpy from gizmo_msgs/RecordBagfileActionResult.msg. Do not edit."""
import codecs
import sys
...
class RecordBagfileActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "gizmo_msgs/RecordBagfileActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gizmo_msgs/RecordBagfileResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RecordBagfileActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = gizmo_msgs.msg.RecordBagfileResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = gizmo_msgs.msg.RecordBagfileResult()
