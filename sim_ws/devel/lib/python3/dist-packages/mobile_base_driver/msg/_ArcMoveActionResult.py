...
"""autogenerated by genpy from mobile_base_driver/ArcMoveActionResult.msg. Do not edit."""
import codecs
import sys
...
class ArcMoveActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "mobile_base_driver/ArcMoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mobile_base_driver/ArcMoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArcMoveActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = mobile_base_driver.msg.ArcMoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = mobile_base_driver.msg.ArcMoveResult()
