...
"""autogenerated by genpy from mobile_base_driver/ArcMoveActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ArcMoveActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "mobile_base_driver/ArcMoveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mobile_base_driver/ArcMoveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArcMoveActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = mobile_base_driver.msg.ArcMoveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = mobile_base_driver.msg.ArcMoveFeedback()
