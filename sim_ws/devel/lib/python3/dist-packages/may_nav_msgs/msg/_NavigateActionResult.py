...
"""autogenerated by genpy from may_nav_msgs/NavigateActionResult.msg. Do not edit."""
import codecs
import sys
...
class NavigateActionResult(genpy.Message):
  ...
  _type = "may_nav_msgs/NavigateActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','may_nav_msgs/NavigateResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = may_nav_msgs.msg.NavigateResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = may_nav_msgs.msg.NavigateResult()
